...
(
    ...
    assign data2mdc0 = pre_mdc_stage_dout_0[PREMDC_STAGES-1];
    assign data2mdc1 = pre_mdc_stage_dout_1[PREMDC_STAGES-1];
    assign data2mdc2 = pre_mdc_stage_dout_2[PREMDC_STAGES-1];
    assign data2mdc3 = pre_mdc_stage_dout_3[PREMDC_STAGES-1];

    assign data_valid2mdc = pre_mdc_stage_data_valid_out[PREMDC_STAGES-1];
