CAPI=2:
name: "aisec:dv:ntt_r4mdc_${ntt.q}_${ntt.n}_${ntt.pes}:0.1"
description: "R4MDC NTT DV"
...
filesets:
  files_dv:
    depend:
      - aisec:dv:tb_pkg
      - aisec:dv:ntt_r4mdc:0.1

parameters:

  TARGET_XILINX_7_SERIES_UNSIGNED:
    datatype: bool
    paramtype: vlogdefine

  TARGET_XILINX_ULTRASCLAE_PLUS_UNSIGNED:
    datatype: bool
    paramtype: vlogdefine
  ...
  TEX_FILE:
    datatype: str
    description: File location to save results in .tex form
    default: "../../../lololog.tex"
    paramtype: vlogparam
  ...
  QMU:
    datatype: int
    description: Lower 32 bits of constant for barrett multiplication
    default: 134219775
    paramtype: vlogparam

  QMU_64:
    datatype: int
    description: Upper 32 bits of constant for barrett multiplication
    default: 0
    paramtype: vlogparam
  ...
  TESTCASE_PATH:
    datatype: str
    description: Test vectors base path
% if mode == "dit":
    default: "../../../hw/dv/testvectors/ntt_${ntt.q}_${ntt.n}/"
% else:
    default: "../../../hw/dv/testvectors/intt_${ntt.q}_${ntt.n}/"
% endif
    paramtype: vlogparam
...
targets:
  default: &default_target
    ...
    filesets:
      - files_dv
    toplevel: tb_ntt_r4mdc
    tools:
      modelsim:
        vsim_options:
          - -modelsimini ../../../hw/dv/modelsim.ini
          - -voptargs="+acc"
          - -work work
          - -L xpm
          - -L unisim
  ...
  ${ntt.q}_${ntt.n}_dit:
    ...
    parameters:
      ...
      - BUTTERFLY_TYPE=CT
      - TEST_NAME=${ntt.q}_${ntt.n}
      - TESTCASE_PATH=../../../hw/dv/testvectors/ntt_${ntt.q}_${ntt.n}/
