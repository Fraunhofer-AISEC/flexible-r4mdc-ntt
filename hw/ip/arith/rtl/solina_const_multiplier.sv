...
module solina_const_multiplier
#(
...
(
  ...
  logic [DATA_WIDTH+NOF_CSASTAGES-1:0] res_csa_d;
  logic [DATA_WIDTH+NOF_CSASTAGES-1:0] res_csa_q;
  generate;
...
endmodule: solina_const_multiplier
