CAPI=2:
name: "aisec:ip:ntt_r4mdc_${ntt.q}_${ntt.n}_${ntt.pes}:0.1"
description: "R4MDC NTT IP"
...
filesets:
  files_rtl:
    depend:
      - aisec:ip:ntt_r4mdc
    files:
      - rtl/ntt_r4mdc_synth_wrapper.sv
    file_type: systemVerilogSource
  files_xilinx:
    files:
      - synth/constraints.xdc
    file_type: xdc
...
targets:
  default: &default_target
    filesets:
      - files_rtl
    toplevel: ntt_r4mdc_synth_wrapper
  ...
  ${ntt.q}_${ntt.n}_v7_dit:
    ...
    filesets:
      ...
      - files_xilinx
    parameters:
      - TARGET_XILINX_7_SERIES_UNSIGNED=true
      - N=${ntt.n}
      - DATA_WIDTH=${ntt.dw}
      - QINT=${low32(ntt.q)}
      - QINT_64=${high32(ntt.q)}
