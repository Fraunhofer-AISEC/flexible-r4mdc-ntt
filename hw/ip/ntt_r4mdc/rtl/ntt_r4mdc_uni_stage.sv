...
(
    ...
    // Butterfly unit
    logic [DATA_WIDTH-1:0] bf0_in;
    logic [DATA_WIDTH-1:0] bf1_in;
    logic [DATA_WIDTH-1:0] bf2_in;
    logic [DATA_WIDTH-1:0] bf3_in;
    ...
    // Reorder Switch     
    logic [DATA_WIDTH-1:0] sw0_in;
    logic [DATA_WIDTH-1:0] sw1_in;
    logic [DATA_WIDTH-1:0] sw2_in;
    logic [DATA_WIDTH-1:0] sw3_in;

    logic [DATA_WIDTH-1:0] sw0_out;
    logic [DATA_WIDTH-1:0] sw1_out;
    logic [DATA_WIDTH-1:0] sw2_out;
    logic [DATA_WIDTH-1:0] sw3_out;
    ...
    assign bf0_in = intt_i ? sw0_out : data0_q;
    assign bf1_in = intt_i ? sw1_out : data1_q;
    assign bf2_in = intt_i ? sw2_out : data2_q;
    assign bf3_in = intt_i ? sw3_out : data3_q;

    assign sw0_in = intt_i ? data0_q : bf0_out;
    assign sw1_in = intt_i ? data1_q : bf1_out;
    assign sw2_in = intt_i ? data2_q : bf2_out;
    assign sw3_in = intt_i ? data3_q : bf3_out;

    assign data0_o = intt_i ? bf0_out : sw0_out;
    assign data1_o = intt_i ? bf1_out : sw1_out;
    assign data2_o = intt_i ? bf2_out : sw2_out;
    assign data3_o = intt_i ? bf3_out : sw3_out;
    ...
    assign sw_cnt_en = intt_i ? (data_valid_q | rd_en_fifo0_3 | dataval2out) : 
    ...
    always_ff @(posedge clk_i) begin
        if (rst_i) begin
           ...
           twiddle_cnt_shreg <= {twiddle_cnt_shreg[$left(twiddle_cnt_shreg)-1:0], sw2out_valid};
        end
    end
    ...
    logic rd_en_fifo0_2_shreg_in;
    logic rd_en_fifo0_3_shreg_in;
    
    assign rd_en_fifo0_1_shreg_in = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
    assign rd_en_fifo0_2_shreg_in = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
        ...
        if (FIFO_DEPTH_0_2 > 1) begin
            ...
            always_ff @(posedge clk_i) begin
                if (rst_i) begin
                    ...
                    rd_en_fifo0_2_shreg <= {rd_en_fifo0_2_shreg[$left(rd_en_fifo0_2_shreg)-1:0], rd_en_fifo0_2_shreg_in};
                end
            end
            ...
            always_ff @(posedge clk_i) begin
                if (rst_i) begin
                    ...
                    rd_en_fifo0_2 <= rd_en_fifo0_2_shreg_in;
                end
            end
    ...
    always_comb begin
        case (sw_sel)
            ...
            2'b01: begin
                ...
                sw2fifo_wen_fifo_1 = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
            ...
            2'b11: begin
                ...
                sw2out_valid = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
            end 
    ...
    assign sw0_out = fifo2out0;
    assign sw1_out = fifo2out1;
    assign sw2_out = fifo2out2;
    assign sw3_out = sw2out;

    logic rd_en_fifo1_0_shreg_in;
    logic rd_en_fifo1_1_shreg_in;
    logic rd_en_fifo1_2_shreg_in;
    
    assign rd_en_fifo1_0_shreg_in = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
    assign rd_en_fifo1_1_shreg_in = intt_i ? data_valid_q : dataval_shreg[$left(dataval_shreg)];
        ...
        if (FIFO_DEPTH_1_1 > 1) begin
            ...
            always_ff @(posedge clk_i) begin
                if (rst_i) begin
                    ...
                    rd_en_fifo1_1_shreg <= {rd_en_fifo1_1_shreg[$left(rd_en_fifo1_1_shreg)-1:0], rd_en_fifo1_1_shreg_in};
                end
            end
            ...
            always_ff @(posedge clk_i) begin
                if (rst_i) begin
                    ...
                    rd_en_fifo1_1 <= rd_en_fifo1_1_shreg_in;
                end
            end
